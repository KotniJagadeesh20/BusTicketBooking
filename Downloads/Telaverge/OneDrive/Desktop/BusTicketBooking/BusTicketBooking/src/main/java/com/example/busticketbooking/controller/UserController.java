...
public class UserController {
	...
	public ResponseEntity<String> bookTicket(@RequestHeader("Authorization") String jwt,
			@RequestBody Bookingdetails bookingDetails, @PathVariable("busid") Bus busid,
			@PathVariable("userid") UserAdmin userid) {
	...
	public ResponseEntity<?> bookingDetails(@RequestHeader("Authorization") String jwt,
			@PathVariable("userid") int userid) {
		List<Object> bookDetails = bookingService.getBookingDetails(userid);
	...
	public ResponseEntity<UserAdminResponse> editUser(@RequestHeader("Authorization") String jwt,
	...
	public ResponseEntity<?> cancelTicket(@RequestHeader("Authorization") String jwt,
			@PathVariable("id") int ticketiid) {
		boolean cancelTicket = bookingService.cancelTickets(ticketiid);
		Map<String, Object> response = new HashMap<>();
		...
		if (cancelTicket) {
			...
			response.put("message", "Booking not cancelled");
